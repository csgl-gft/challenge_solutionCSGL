...
public class AccountsControllerTest {
	...
	@Test
	public void testAccountTransferOk() throws Exception {
		// Set Initial Data
		...
		// perform the Rest execution
		this.mockMvc
				.perform(post("/v1/accounts/" + fromAccountId + " /transfers")
						.contentType(MediaType.APPLICATION_JSON)
						.content("{\"toAccountId\":\"" + toAccountId + "\",\"ammount\":250}"))
				.andExpect(status().isOk());

	}

	@Test
	public void testAccountTransferKo() throws Exception {
		// Set Initial Data
		String fromAccountId = "Id-12345";
		Account fromAccount = new Account(fromAccountId, new BigDecimal("1000.50"));
		this.accountsService.createAccount(fromAccount);
		...
		this.mockMvc
				.perform(post("/v1/accounts/" + fromAccountId + " /transfers")
						.contentType(MediaType.APPLICATION_JSON)
						.content("{\"toAccountId\":\"" + toAccountId + "\",\"ammount\":0}"))
				.andExpect(status().isBadRequest());
